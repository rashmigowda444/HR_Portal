...
$leave_balance=$row['leave_balance'];
	...
	if($no_days <= $leave_balance){
		$leave="Select leave_id,leave_type,leave_entitlements from tekhub_leaves as A join tekhub_user_leave as B on A.leave_id=B.leave_id where A.leave_id='$leave_type'";
